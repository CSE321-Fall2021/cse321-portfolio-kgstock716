...
void isr_c1(void){
    ...
    //might add in condition for row == 2 if using C for extra credit
}
...
void isr_c2(void){
    ...
    //If row == 1, key is #. We have no use for # in this project
}
...
void isr_c4(void){
    ...
    //if row == 1, key is *. No use for * in this project.
}